...
class EditMessageBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(currentMessage: String): EditMessageBottomSheetFragment {
            return EditMessageBottomSheetFragment().apply {
