...
data class Data (
    ...
    @SerializedName("freeCancelBy"        ) var freeCancelBy        : String?                 = null,
    @SerializedName("gstRate"             ) var gstRate             : Int?                    = null,
    @SerializedName("freeCancel"          ) var freeCancel          : Boolean?                = null,
)