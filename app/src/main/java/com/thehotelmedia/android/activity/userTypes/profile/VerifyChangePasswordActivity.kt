...
import com.thehotelmedia.android.databinding.ActivityVerifyChangePasswordBinding
...
class VerifyChangePasswordActivity : BaseActivity() {

    private lateinit var binding: ActivityVerifyChangePasswordBinding
    private var userEmailAddress : String = ""
    private var resetToken : String = ""
    private lateinit var authViewModel: AuthViewModel
    private val activity = this@VerifyChangePasswordActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityVerifyChangePasswordBinding.inflate(layoutInflater)
    ...
    private fun initUI() {
        ...
        authViewModel.forgotPasswordResult.observe(activity){result->
            if (result.status==true){
                userEmailAddress = result.data?.email.toString()
                resetToken = result.data?.resetToken.toString()
    ...
    private fun sentOtp() {
        authViewModel.forgotPassword(userEmailAddress)
    }
}