...
//            binding.addDot.visibility = View.GONE
    ...
    private fun openStoryById(storyId: String) {
        lifecycleScope.launch {
            try {
                val repo = IndividualRepo(this@BottomNavigationIndividualMainActivity)
                ...
                val viewIntent = Intent(this@BottomNavigationIndividualMainActivity, ViewStoriesActivity::class.java).apply {
