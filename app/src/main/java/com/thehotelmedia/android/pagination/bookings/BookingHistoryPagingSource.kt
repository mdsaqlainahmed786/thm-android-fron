package com.thehotelmedia.android.pagination.bookings
...
class BookingHistoryPagingSource(
...
) : PagingSource<Int, BookingHistoryData>() {
    private val tag = "PAGING_ACTIVE_TAGGED"
    private var maxPageLimit: Int? = null

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, BookingHistoryData> {
        ...
        try {
            ...
            val response = repository
                .getBookingHistory( nextPageNumber, 20)
            ...
            return if (response.isSuccessful) {
                ...
                val services = response.body()?.bookingHistoryData ?: emptyList()
    ...
    override fun getRefreshKey(state: PagingState<Int, BookingHistoryData>): Int? {
