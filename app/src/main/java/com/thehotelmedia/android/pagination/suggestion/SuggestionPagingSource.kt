package com.thehotelmedia.android.pagination.suggestion
...
class SuggestionPagingSource(
    private val repository: IndividualRepo
) : PagingSource<Int, SuggestionData>() {
    private val tag = "PAGING_ACTIVE_TAGGED"
    private var maxPageLimit: Int? = null

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, SuggestionData> {
        ...
        try {
            ...
            val response = repository
                .getSuggestions( nextPageNumber, 20)
            ...
            return if (response.isSuccessful) {
                ...
                val services = response.body()?.suggestionData ?: emptyList()
    ...
    override fun getRefreshKey(state: PagingState<Int, SuggestionData>): Int? {
