...
class ViewerStoryAdapter(
    private val context: Context,
    private val childFragmentManager: FragmentManager,
    private val individualViewModal: IndividualViewModal,
    private val coroutineScope: CoroutineScope
    ): PagingDataAdapter<LikeData, ViewerStoryAdapter.ViewHolder>(COMPARATOR)  {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewerStoryAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ViewerStoryAdapter.ViewHolder, position: Int) {
        ...
        views?.let { it ->
            ...
            binding.menuBtn.setOnClickListener {
                openBottomSheet(userId,userName,binding,views)
