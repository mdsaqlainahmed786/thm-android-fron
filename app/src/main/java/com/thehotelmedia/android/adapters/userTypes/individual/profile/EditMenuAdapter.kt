...
import com.thehotelmedia.android.databinding.EditMenuItemsLayoutBinding
import com.thehotelmedia.android.modals.menu.MenuItem

class EditMenuAdapter(
    private val context: Context,
    private val onDeleteClick: (MenuItem) -> Unit
) : ListAdapter<MenuItem, EditMenuAdapter.ViewHolder>(COMPARATOR) {

    inner class ViewHolder(val binding: EditMenuItemsLayoutBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = EditMenuItemsLayoutBinding.inflate(
